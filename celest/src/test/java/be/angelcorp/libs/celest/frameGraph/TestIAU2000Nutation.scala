...
import be.angelcorp.libs.celest.frameGraph.frames.transforms._
...
class TestIAU2000Nutation extends FlatSpec with ShouldMatchers {
  ...
  "IAU2000Nutation" should "match the IAU2000A SOFA values" in {
    ...
    ArcSecond.convert( δε ) should be ( -2.969698055733905e-005 plusOrMinus ArcSecond.convert(1E-3) )
  ...
  it  should "match the IAU2006A SOFA values" in {
    ...
    ArcSecond.convert( δε ) should be ( -2.9696969571191937e-005 plusOrMinus ArcSecond.convert(1E-3) )

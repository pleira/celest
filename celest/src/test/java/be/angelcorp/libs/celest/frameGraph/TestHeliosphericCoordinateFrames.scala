...
import be.angelcorp.libs.celest.frameGraph.frames.HeliosphericCoordinateFrames
...
class TestHeliosphericCoordinateFrames extends FlatSpec with ShouldMatchers {
  ...
  val transforms = new HeliosphericCoordinateFrames()
	 ...
	 */
	val referenceEpoch     = new JulianDate( 1996, 28, 8, 16, 46, 00, universe.TT )
	val Re                 = 6378.14E3
	val referenceDistances = Map(
		//(transforms.GEO_T(), 			Vector3D( 6.9027400, -1.6362400,  1.9166900)),
		(transforms.GEI_D_TRUE(), 	Vector3D(-5.7864335, -4.1039357,  1.9166900)),
		(transforms.GEI_D_MEAN(), 	Vector3D(-5.7864918, -4.1039136,  1.9165612)),
		(transforms.HAE_D(), 				Vector3D(-5.7864918, -3.0028771,  3.3908764)),
		(transforms.HAE_J2000(), 		Vector3D(-5.7840451, -3.0076174,  3.3908496)),
		(transforms.GEI_J2000(), 		Vector3D(-5.7840451, -4.1082375,  1.9146822))
		//(transforms.HGC_J2000(), 	Vector3D(-5.4328785,  4.1138243,  2.7493786)),
		//(transforms.HEE_D(), 			Vector3D(-4.0378470, -5.1182566,  3.3908764)),
		//(transforms.HEEQ_D(), 		Vector3D(-4.4132668, -5.1924440,  2.7496187)),
		//(transforms.HCD(), 				Vector3D(-4.3379628,  5.2555187,  2.7496187)),
		//(transforms.GSE_D(), 			Vector3D( 4.0378470,  5.1182566,  3.3908764)),
		//(transforms.GSM_D(), 			Vector3D( 4.0378470,  6.0071917,  1.2681645)),
		//(transforms.SM_D(), 			Vector3D( 3.3601371,  6.0071917,  2.5733108)),
		//(transforms.MAG_D(), 			Vector3D( 3.3344557,  6.0215108,  2.5732497)),
		//(transforms.HGRTN_E(), 		Vector3D( 4.0360303,  5.1931904, -3.2771992))
	)

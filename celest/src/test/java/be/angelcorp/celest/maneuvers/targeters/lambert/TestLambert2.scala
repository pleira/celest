...
class TestLambert2 extends FlatSpec with Matchers with CelestTest {
  ...
  "The lambert targetter " should "solve the N=0 revolutions case" in {
    val r1 = Array(4949101.4221185260000000, 859402.4430396953800000, -151535.8379946680200000) //m
    val r2 = Array(3648349.9884584765000000, 4281879.3154454567000000, -755010.8514505261600000) //m
    ...
    val s0 = new PosVel(r1, DCoord.zero, centerFrame)
    val s1 = new PosVel(r2, DCoord.zero, centerFrame)
    val t0 = Epochs.J2000
    val te = t0 + tf

    val v1_prograde_true = Array(10096.6831628413530000, 4333.9040463802048000, -764.1842151784204600) // m/s
    val v2_prograde_true = Array(-8110.7563755037318000, -6018.4641067406237000, 1061.2176044438429000) // m/s
    val v1_retrograde_true = Array(1315.7261324536535000, -10735.1341404250650000, 1892.8937904815141000) // m/s
    val v2_retrograde_true = Array(5601.4255704605439000, -8298.3753483701657000, 1463.2274699636678000) // m/s
  ...
  "The lambert targetter" should "solve the N=1 revolutions case" in {
    ...
    val v1_prograde_left = Array(-1265.9264854521123000, 10660.0671819508730000, -1879.6574603427921000) //m/s
    val v2_prograde_left = Array(-5584.6019382811455000, 8204.5589196619712000, -1446.6851023487011000) //m/s
    val v1_prograde_right = Array(8918.2511158662492000, 4409.3440789097822000, -777.4863283389091700) //m/s
    val v2_prograde_right = Array(-7506.6196898669295000, -4929.4928888196837000, 869.2025975094234100) //m/s
    val v1_retrograde_left = Array(-9921.3226492572248000, -4341.8848035061446000, 765.5914379862049400) //m/s
    val v2_retrograde_left = Array(8018.9435079575824000, 5858.5741700537847000, -1033.0246946621844000) //m/s
    val v1_retrograde_right = Array(629.8861440442892700, -9747.3484276097843000, 1718.7205181538370000) //m/s
    val v2_retrograde_right = Array(5396.8566431760819000, -7036.9490066396938000, 1240.8039717402089000) //m/s
  ...
  "The lambert targetter" should "solve the N=4 revolutions case" in {
    ...
    val v1_prograde_left = Array(1618.0817850488665000, 7225.3760295109969000, -1274.0287397669906000) //m/s
    val v2_prograde_left = Array(-5148.0510872930554000, 3378.2948229580488000, -595.6845260752310200) //m/s
    val v1_prograde_right = Array(4812.3627329127148000, 5280.0203047887999000, -931.0100384227980600) //m/s
    val v2_prograde_right = Array(-5759.8462467333111000, -731.1159298546271000, 128.9154644591281700) //m/s
    val v1_retrograde_left = Array(-5076.6084677018716000, -5182.5921327988517000, 913.8308230198654200) //m/s
    val v2_retrograde_left = Array(5847.8739683299273000, 1028.8393989069427000, -181.4121448431730500) //m/s
    val v1_retrograde_right = Array(-2546.0418701126791000, -6488.7220023867440000, 1144.1367593374396000) //m/s
    val v2_retrograde_right = Array(5224.7179917529947000, -2070.4309653571795000, 365.0728408867440200) //m/s

...
class TestLambert2 extends FlatSpec with ShouldMatchers {
  ...
  "The lambert targetter" should "solve the N=0 revolutions case" in {
    ...
    val r2 = Vector3D(3648349.9884584765000000, 4281879.3154454567000000, -755010.8514505261600000) //m
    val tf = 0.1192989774980580 // days
    val N = 0
    val mu = 3986004418E5 // m^3/s^2

    val centerFrame = frames.BodyCentered(new Satellite(mu2mass(mu)))
  ...
  "The lambert targetter" should "solve the N=1 revolutions case" in {
    ...
    val v1_prograde_right = Vector3D(8918.2511158662492000, 4409.3440789097822000, -777.4863283389091700) //m/s
    val v2_prograde_right = Vector3D(-7506.6196898669295000, -4929.4928888196837000, 869.2025975094234100) //m/s
    val v1_retrograde_left = Vector3D(-9921.3226492572248000, -4341.8848035061446000, 765.5914379862049400) //m/s
    val v2_retrograde_left = Vector3D(8018.9435079575824000, 5858.5741700537847000, -1033.0246946621844000) //m/s
  ...
  "The lambert targetter" should "solve the N=4 revolutions case" in {
    ...
    val v1_prograde_right = Vector3D(4812.3627329127148000, 5280.0203047887999000, -931.0100384227980600) //m/s
    val v2_prograde_right = Vector3D(-5759.8462467333111000, -731.1159298546271000, 128.9154644591281700) //m/s
    val v1_retrograde_left = Vector3D(-5076.6084677018716000, -5182.5921327988517000, 913.8308230198654200) //m/s
    val v2_retrograde_left = Vector3D(5847.8739683299273000, 1028.8393989069427000, -181.4121448431730500) //m/s

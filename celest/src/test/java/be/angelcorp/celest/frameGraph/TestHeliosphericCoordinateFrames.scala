...
class TestHeliosphericCoordinateFrames extends FlatSpec with CelestTest {
  ...
  val referenceDistances = Map(
    //(transforms.GEO_T(), 			Array( 6.9027400, -1.6362400,  1.9166900)),
    (transforms.GEI_D_TRUE(), Array(-5.7864335, -4.1039357, 1.9166900)),
    (transforms.GEI_D_MEAN(), Array(-5.7864918, -4.1039136, 1.9165612)),
    (transforms.HAE_D(), Array(-5.7864918, -3.0028771, 3.3908764)),
    (transforms.HAE_J2000(), Array(-5.7840451, -3.0076174, 3.3908496)),
    (transforms.GEI_J2000(), Array(-5.7840451, -4.1082375, 1.9146822))
    //(transforms.HGC_J2000(), 	Array(-5.4328785,  4.1138243,  2.7493786)),
    //(transforms.HEE_D(), 			Array(-4.0378470, -5.1182566,  3.3908764)),
    //(transforms.HEEQ_D(), 		Array(-4.4132668, -5.1924440,  2.7496187)),
    //(transforms.HCD(), 				Array(-4.3379628,  5.2555187,  2.7496187)),
    //(transforms.GSE_D(), 			Array( 4.0378470,  5.1182566,  3.3908764)),
    //(transforms.GSM_D(), 			Array( 4.0378470,  6.0071917,  1.2681645)),
    //(transforms.SM_D(), 			Array( 3.3601371,  6.0071917,  2.5733108)),
    //(transforms.MAG_D(), 			Array( 3.3344557,  6.0215108,  2.5732497)),
    //(transforms.HGRTN_E(), 		Array( 4.0360303,  5.1931904, -3.2771992))
  )
  ...
  "GEI_J2000" should "transform to GEI_D_MEAN" in {
    val pos_calc = transforms.transform_GEI_J2000_To_GEI_D_MEAN.transform(referenceEpoch).transform(
      new PosVel(referenceDistances.get(transforms.GEI_J2000()).get :* Re, DCoord.zero, null)
    )
  ...
  "GEI_D_MEAN" should "transform to GEI_D_TRUE" in {
    val pos_calc = transforms.transform_GEI_D_MEAN_To_GEI_D_TRUE.transform(referenceEpoch).transform(
      new PosVel(referenceDistances.get(transforms.GEI_D_MEAN()).get :* Re, DCoord.zero, null)
    )
  ...
  "HAE_J2000" should "transform to HAE_D" in {
    val pos_calc = transforms.transform_HAE_J2000_To_HAE_D.transform(referenceEpoch).transform(
      new PosVel(referenceDistances.get(transforms.HAE_J2000()).get :* Re, DCoord.zero, null)
    )

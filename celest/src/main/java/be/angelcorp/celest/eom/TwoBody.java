 ...
 */
package be.angelcorp.celest.eom;

import be.angelcorp.celest.body.ICelestialBody;
import be.angelcorp.celest.body.bodyCollection.ITwoBodyCollection;
import be.angelcorp.celest.eom.forcesmodel.ForceModelCore;
import be.angelcorp.celest.eom.forcesmodel.GravitationalForce_C;
...
public class TwoBody extends ForceModelCore {
     ...
     *
     * @param bodies The two body system considered
     * @param body   The body for which to compute the {@link be.angelcorp.celest.state.IStateDerivative}
     */

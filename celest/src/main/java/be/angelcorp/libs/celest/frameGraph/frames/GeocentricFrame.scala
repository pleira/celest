 ...
 */
package be.angelcorp.libs.celest.frameGraph.frames

import be.angelcorp.libs.celest.frameGraph.ReferenceFrame
import be.angelcorp.libs.celest.frameGraph.systems._
import be.angelcorp.libs.celest.universe.Universe

/**
 * The ITRF (International Terrestrial Reference Frame) is the default implementation of the
 * [[be.angelcorp.libs.celest.frameGraph.systems.ITRS]]. It comes in several definitions based
 * on different years:
 * <p>
...
object ITRF {
   ...
   */
  def itrfPreficate(year: Int) = (frame: ReferenceFrame) => frame match {
    case ITRF(`year`) => true
    case _=> false
  }
...
/** Default implementation of the [[be.angelcorp.libs.celest.frameGraph.systems.TIRS]] reference system. */
case class TIRF() extends TIRS

/** Default implementation of the [[be.angelcorp.libs.celest.frameGraph.systems.ERS]] reference system. */
case class ERF() extends ERS

/** Default implementation of the [[be.angelcorp.libs.celest.frameGraph.systems.MODs]] reference system. */
case class MOD() extends MODs

/** Default implementation of the [[be.angelcorp.libs.celest.frameGraph.systems.J2000s]] reference system. */
case class J2000() extends J2000s

/** Default implementation of the [[be.angelcorp.libs.celest.frameGraph.systems.GCRS]] reference system. */

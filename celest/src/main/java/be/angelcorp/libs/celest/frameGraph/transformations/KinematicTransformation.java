...
import be.angelcorp.libs.celest.frameGraph.BasicReferenceFrameTransform;
...
public class KinematicTransformation<F0 extends ReferenceFrame, F1 extends ReferenceFrame> extends
	 ...
	 * new {@link be.angelcorp.libs.celest.frameGraph.ReferenceFrameTransform}'s like this one, but for various other epochs. Furthermore a
	 ...
	 * @param parameters
	 *            Parameters describing the transform between the two frameGraph.
	 */

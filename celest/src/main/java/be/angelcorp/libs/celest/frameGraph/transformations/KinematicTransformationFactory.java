...
import be.angelcorp.libs.celest.frameGraph.BasicReferenceFrameTransformFactory;
import be.angelcorp.libs.celest.frameGraph.ReferenceFrame;
import be.angelcorp.libs.celest.frameGraph.ReferenceFrameTransform;
import be.angelcorp.libs.celest.frameGraph.ReferenceFrameTransformFactory;
 ...
 * {@link be.angelcorp.libs.celest.frameGraph.ReferenceFrameTransformFactory#calculateParameters(be.angelcorp.libs.celest.time.Epoch)} is implemented.
 * <p>
 ...
 * {@link be.angelcorp.libs.celest.frameGraph.ReferenceFrameTransform} is constructed that can perform the actual transformation between the
 * two frameGraph.
 * </p>
 * 
...
public abstract class KinematicTransformationFactory<F0 extends ReferenceFrame, F1 extends ReferenceFrame>
	...
	/**
	 * A special form of the {@link be.angelcorp.libs.celest.frameGraph.ReferenceFrameTransformFactory} which produces the inverse transform
	...
	public class ReferenceFrameTransformInverseFactory extends BasicReferenceFrameTransformFactory<F1, F0> {
		 ...
		 * {@link be.angelcorp.libs.celest.frameGraph.ReferenceFrameTransformFactory}.
		 * 
		 * @param factory

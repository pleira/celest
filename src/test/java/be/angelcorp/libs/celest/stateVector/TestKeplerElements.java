...
public class TestKeplerElements extends TestStateVector<KeplerElements> {
	...
	public void testAs() {
		...
		c = new CartesianElements(
				new ImmutableVector3D(-1.15037391547548e+008, -3.64408052048568e+008, -1.21513857899935e+007),
				new ImmutableVector3D(+9.67536480042629e+002, -3.46497896859408e+002, +8.78970130662041e+001));

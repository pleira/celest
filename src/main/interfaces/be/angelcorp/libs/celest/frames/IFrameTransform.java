 ...
 */
public interface IFrameTransform {

	/**
	 * Get a new transform that, when applied, undoes the effects performed by this transformation.
	 * This means:
	 * 
	 * <pre>
	 ...
	 * </pre>
	 * 
	 * @return An inverse transformation of this {@link IFrameTransform}
	 */
	public abstract IFrameTransform inverse();
	 ...
	 * @return A new {@link IOrientationState} which is equivalent to given
	 *         {@link IOrientationState}, but in the new {@link IReferenceFrame}.
	 */
	 ...
	 * @return A new {@link IPositionState} which is equivalent to given {@link IPositionState}, but
	 *         in the new {@link IReferenceFrame}.
	 */
	 ...
	 * @returnA new orientation rate which is equivalent to given provided orientation rate, but in

...
object HeliosphericCoordinateSystems {
	...
	lazy val frameGraph = {
		val graph = new ReferenceFrameGraph( new DefaultDirectedWeightedGraph[IReferenceFrame, IReferenceFrameTransformFactory[_,_]]( classOf[IReferenceFrameTransformFactory[_,_]] ) )
	 ...
	 * (GEI_D_MEAN, MOD). Implementations of GEI_J2000 are the ICRF reference frames.
	 *

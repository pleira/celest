...
/**
 * An {@link IReferenceFrameTransformFactory} which produces transformations based on a set of Helmert
 ...
 * </p>
 * <ul>
 * <li>\(\dot{T} = \{\dot{T}_x, \dot{T}_y, \dot{T}_z\}\): Velocity between frames F0 and F1 [m/s]</li>
 ...
 * 
 * @param <F0>
 *            Create a transformation from this frame.
 * @param <F1>
 *            Create a transformation from to frame.
 */
public class HelmertTransformationFactory<F0 extends IReferenceFrame, F1 extends IReferenceFrame>
		extends ReferenceFrameTransformFactory<F0, F1> {
	...
	public static <F0 extends IReferenceFrame, F1 extends IReferenceFrame> HelmertTransformationFactory<F0, F1> fromIERSunits(
		...
		return new HelmertTransformationFactory<F0, F1>(epoch, T, S, R, dT, dS, dR);
	}
	 ...
	 *            Epoch at which the initial parameters are valid.
	 * @param Tx
	 *            Translation x component at Helmert parameters epoch [m].
	 * @param Ty
	 *            Translation y component at Helmert parameters epoch [m].
	 * @param Tz
	 *            Translation z component at Helmert parameters epoch [m].
	 * @param S
	 *            Scaling parameter at Helmert parameters epoch [-].
	 * @param Rx
	 *            Rotation axis x component at Helmert parameters epoch [rad].
	 * @param Ry
	 *            Rotation axis y component at Helmert parameters epoch [rad].
	 * @param Rz
	 *            Rotation axis z component at Helmert parameters epoch [rad].
	 * @param dTx
	 *            Velocity x component at Helmert parameters epoch [m/s].
	 * @param dTy
	 *            Velocity y component at Helmert parameters epoch [m/s].
	 * @param dTz
	 *            Velocity z component at Helmert parameters epoch [m/s].
	 * @param dS
	 *            Scaling parameter derivative at Helmert parameters epoch [-/s].
	 * @param dRx
	 *            Rotation rate x component at Helmert parameters epoch [rad/s].
	 * @param dRy
	 *            Rotation rate y component at Helmert parameters epoch [rad/s].
	 * @param dRz
	 ...
	 *            Epoch at which the initial parameters are valid.
	 * @param T0
	 *            Translation at Helmert parameters epoch [m].
	 * @param dT0
	 *            Velocity at Helmert parameters epoch [m/s].
	 * @param R0
	 *            Rotation axis scaled with rotation angle at Helmert parameters epoch [rad].
	 * @param dR0
	 *            Rotation rate of the rotation angle at Helmert parameters epoch [rad/s].
	 * @param s0
	 *            Scaling parameter at Helmert parameters epoch [-].
	 * @param ds0
	 *            Scaling parameter derivative at Helmert parameters epoch [-/s].

...
/**
 * Basic implementation of a [[be.angelcorp.libs.celest.body.bodyCollection.IBodyCollection]] using a [[scala.collection.mutable.Set]]
 *
 * @param bodySet Collection of bodies in the [[be.angelcorp.libs.celest.body.bodyCollection.IBodyCollection]]
 *
